...
void World::parse(uint8_t* data) {
    ...
    for (uint32_t i = 0; i < this->tile_count; ++i) {
        ...
        // if tile has_parent (bit 2)
        if ((tile.flags & 0x2) != 0) {
            position += sizeof(uint16_t);
        }

        // if tile has_extra_data (bit 1)
        if ((tile.flags & 0x1) != 0) {
...
void World::get_extra_tile_data(Tile& tile, uint8_t* data, size_t& position, uint8_t extra_tile_type) {
    ...
    case 2: { // TileType::Sign (updated: skip 4 bytes after reading text)
        Sign sign;
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
    ...
    case 3: { // TileType::Lock (updated: no unknown_1 array, always skip 7 bytes)
        Lock lock;
        ...
        // if foreground_item_id == 5814 => skip 16
    ...
    case 6: { // TileType::Mailbox
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        mailbox.unknown_1.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        mailbox.unknown_2.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        mailbox.unknown_3.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
    ...
    case 7: { // TileType::Bulletin
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        bulletin.unknown_1.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        bulletin.unknown_2.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        bulletin.unknown_3.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
    ...
    case 9: { // TileType::ChemicalSource
        ...
        chemical_source.time_passed = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 10: { // TileType::AchievementBlock
        ...
        achievement_block.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 11: { // TileType::HearthMonitor
        ...
        hearth_monitor.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);

        hearth_monitor.player_name.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
    ...
    case 12: { // TileType::DonationBox
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        donation_box.unknown_1.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        donation_box.unknown_2.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        donation_box.unknown_3.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
    ...
    case 14: { // TileType::Mannequin
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        mannequin.text.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
        ...
        mannequin.clothing_10 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
    ...
    case 18: { // TileType::XenoniteCrystal
        ...
        position += sizeof(uint8_t);
        xenonite_crystal.unknown_2 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 19: { // TileType::PhoneBooth
        ...
        phone_booth.clothing_1 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        phone_booth.clothing_2 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        phone_booth.clothing_3 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        phone_booth.clothing_4 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        phone_booth.clothing_5 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        phone_booth.clothing_6 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        phone_booth.clothing_7 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        phone_booth.clothing_8 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        phone_booth.clothing_9 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
    ...
    case 20: { // TileType::Crystal
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        crystal.unknown_1.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
    ...
    case 21: { // TileType::CrimeInProgress
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        crime_in_progress.unknown_1.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        crime_in_progress.unknown_2 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 23: { // TileType::DisplayBlock
        ...
        display_block.item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 24: { // TileType::VendingMachine
        ...
        vending_machine.item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 25: { // TileType::FishTankPort (UPDATED loop)
    ...
    case 26: { // TileType::SolarCollector
        ...
        std::memcpy(solar_collector.unknown_1, &data[position], sizeof(solar_collector.unknown_1));
    ...
    case 28: { // TileType::GivingTree
        ...
        giving_tree.unknown_1 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);

        giving_tree.unknown_2 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 31: { // TileType::SilkWorm
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        silk_worm.name.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
        ...
        // color is u32 => ARGB
        uint32_t color_val = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        silk_worm.color.A = static_cast<uint8_t>((color_val >> 24) & 0xFF);
        silk_worm.color.R = static_cast<uint8_t>((color_val >> 16) & 0xFF);
        silk_worm.color.G = static_cast<uint8_t>((color_val >> 8) & 0xFF);
        silk_worm.color.B = static_cast<uint8_t>(color_val & 0xFF);

        silk_worm.sick_duration = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 33: { // TileType::CountryFlag
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        country_flag.country.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
    ...
    case 34: { // TileType::LobsterTrap
        ...
        tile.data = LobsterTrap{};
        break;
    }
    case 35: { // TileType::PaintingEasel
        PaintingEasel painting_easel;
        painting_easel.item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        painting_easel.label.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
    ...
    case 36: { // TileType::PetBattleCage
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        pet_battle_cage.label.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        pet_battle_cage.base_pet = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        pet_battle_cage.combined_pet_11 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        pet_battle_cage.combined_pet_2 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 37: { // TileType::PetTrainer
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        pet_trainer.name.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        pet_trainer.pet_total_count = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        pet_trainer.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 38: { // TileType::SteamEngine
        ...
        steam_engine.temperature = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 40: { // TileType::WeatherMachine
        ...
        weather_machine.item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 41: { // TileType::SpiritStorageUnit
        ...
        spirit_storage_unit.ghost_jar_count = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 42: { // TileType::DataBedrock
        ...
        std::memcpy(data_bedrock.unknown_1.data(), &data[position], data_bedrock.unknown_1.size());
    ...
    case 43: { // TileType::Shelf
        Shelf shelf;
        shelf.top_left_item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        shelf.top_right_item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        shelf.bottom_left_item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        shelf.bottom_right_item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 44: { // TileType::VipEntrance
        ...
        vip_entrance.owner_uid = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 47: { // TileType::FishWallMount
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        fish_wall_mount.label.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;

        fish_wall_mount.item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 48: { // TileType::Portrait
        ...
        uint16_t str_len = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        portrait.label.assign(reinterpret_cast<const char*>(&data[position]), str_len);
        position += str_len;
    ...
    case 49: { // TileType::GuildWeatherMachine
        ...
        guild_weather_machine.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        guild_weather_machine.gravity = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 50: { // TileType::FossilPrepStation
        ...
        fossil_prep_station.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 53: { // TileType::ChemsynthTank
        ...
        chemsynth_tank.current_chem = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        chemsynth_tank.target_chem = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 55: { // TileType::CookingOven
        ...
        cooking_oven.temperature_level = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        ...
        for (uint32_t i = 0; i < ingredient_count; ++i) {
            ...
            ingredient_info.item_id = *reinterpret_cast<const uint32_t*>(&data[position]);
            position += sizeof(uint32_t);
            ingredient_info.time_added = *reinterpret_cast<const uint32_t*>(&data[position]);
            position += sizeof(uint32_t);

            cooking_oven.ingredients.push_back(ingredient_info);
        }

        cooking_oven.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        cooking_oven.unknown_2 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        cooking_oven.unknown_3 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 56: { // TileType::AudioRack
        ...
        position += sizeof(uint32_t);
        audio_rack.note.assign(reinterpret_cast<const char*>(&data[position]), note_length);
    ...
    case 57: { // TileType::GeigerCharger
        ...
        geiger_charger.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 58: { // TileType::AdventureBegins
        ...
        tile.data = AdventureBegins{};
        break;
    }
    case 59: { // TileType::TombRobber
        tile.type = TileType::TombRobber;
        tile.data = TombRobber{};
        break;
    }
    case 60: { // TileType::BalloonOMatic
        BalloonOMatic balloon_o_matic;
        balloon_o_matic.total_rarity = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        balloon_o_matic.team_type = data[position];
        position += sizeof(uint8_t);
    ...
    case 61: { // TileType::TrainingPort
        ...
        training_port.fish_lb = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        training_port.fish_status = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        training_port.fish_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        training_port.fish_total_exp = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        std::memcpy(training_port.unknown_1, &data[position], sizeof(training_port.unknown_1));
        position += sizeof(training_port.unknown_1);

        training_port.fish_level = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        training_port.unknown_2 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        std::memcpy(training_port.unknown_3, &data[position], sizeof(training_port.unknown_3));
    ...
    case 62: { // TileType::ItemSucker
        ...
        item_sucker.item_id_to_suck = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        item_sucker.item_amount = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 63: { // TileType::CyBot
        ...
        for (uint32_t i = 0; i < command_data_count; ++i) {
            ...
            command_data.command_id = *reinterpret_cast<const uint32_t*>(&data[position]);
            position += sizeof(uint32_t);
            command_data.is_command_used = *reinterpret_cast<const uint32_t*>(&data[position]);
            position += sizeof(uint32_t);
            std::memcpy(command_data.unknown_1, &data[position], sizeof(command_data.unknown_1));
    ...
    case 65: { // TileType::GuildItem
        ...
        std::memcpy(guild_item.unknown_1, &data[position], sizeof(guild_item.unknown_1));
    ...
    case 66: { // TileType::Growscan
        Growscan growscan;
        growscan.unknown_1 = data[position];
        position += sizeof(uint8_t);
    ...
    case 67: { // TileType::ContainmentFieldPowerNode
        ...
        containment_field_power_node.ghost_jar_count = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        ...
        for (uint32_t i = 0; i < unknown_1_size; ++i) {
            uint32_t val = *reinterpret_cast<const uint32_t*>(&data[position]);
            position += sizeof(uint32_t);
            containment_field_power_node.unknown_1[i] = val;
        }
    ...
    case 68: { // TileType::SpiritBoard
        ...
        spirit_board.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        spirit_board.unknown_2 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        spirit_board.unknown_3 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 72: { // TileType::StormyCloud
        ...
        stormy_cloud.sting_duration = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        stormy_cloud.is_solid = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        stormy_cloud.non_solid_duration = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 73: { // TileType::TemporaryPlatform
        ...
        temporary_platform.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
    ...
    case 75: { // TileType::AngelicCountingCloud
        ...
        angelic_counting_cloud.is_raffling = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        angelic_counting_cloud.unknown_1 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);
        angelic_counting_cloud.ascii_code = data[position];
        position += sizeof(uint8_t);
    ...
    case 77: { // TileType::InfinityWeatherMachine
        ...
        infinity_weather_machine.interval_minutes = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        uint32_t weather_machine_list_size = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);

        infinity_weather_machine.weather_machine_list.resize(weather_machine_list_size);
        for (uint32_t i = 0; i < weather_machine_list_size; ++i) {
            uint32_t w = *reinterpret_cast<const uint32_t*>(&data[position]);
            position += sizeof(uint32_t);
            infinity_weather_machine.weather_machine_list[i] = w;
        }
    ...
    case 79: { // TileType::PineappleGuzzler
        ...
        tile.data = PineappleGuzzler{};
        break;
    }
    case 80: { // TileType::KrakenGalaticBlock
        KrakenGalaticBlock kraken_galatic_block;
        kraken_galatic_block.pattern_index = data[position];
        position += sizeof(uint8_t);
        kraken_galatic_block.unknown_1 = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        kraken_galatic_block.r = data[position];
        position += sizeof(uint8_t);
        kraken_galatic_block.g = data[position];
        position += sizeof(uint8_t);
        kraken_galatic_block.b = data[position];
        position += sizeof(uint8_t);
    ...
    case 81: { // TileType::FriendsEntrance
        ...
        friends_entrance.owner_user_id = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
        friends_entrance.unknown_1 = *reinterpret_cast<const uint16_t*>(&data[position]);
        position += sizeof(uint16_t);

        uint32_t allowed_user_list_size = *reinterpret_cast<const uint32_t*>(&data[position]);
        position += sizeof(uint32_t);
